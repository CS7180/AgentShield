...
const ScanMonitorContent = () => {
  const [progress, setProgress] = useState(71);

  const redAgents = [
    { name: "Prompt Injection", status: "running", tested: "12/15", success: 3, gradient: "linear-gradient(90deg, #ef4444, #f97316, #ec4899)" },
    { name: "Jailbreak", status: "done", tested: "10/10", success: 2, gradient: "linear-gradient(90deg, #ec4899, #a855f7, #6366f1)" },
    { name: "Data Leakage", status: "pending", tested: "0/8", success: 0, gradient: "linear-gradient(90deg, #8b5cf6, #6366f1, #3b82f6)" },
    { name: "Constraint Drift", status: "done", tested: "6/6", success: 0, gradient: "linear-gradient(90deg, #6366f1, #3b82f6, #06b6d4)" },
  ];

  const blueAgents = [
    { name: "Input Guard", blocked: 5 },
    { name: "Output Filter", blocked: 2 },
    { name: "Behavior Monitor", blocked: 0 },
    { name: "Constraint Persistence", blocked: 0 },
  ];

  const feed = [
    { time: "14:32:15", type: "red", agent: "Prompt Injection", msg: "Attempted indirect injection via external document", severity: "high" },
    { time: "14:32:12", type: "blue", agent: "Input Guard", msg: "Blocked base64-encoded attack pattern", severity: "low" },
    { time: "14:32:08", type: "red", agent: "Jailbreak", msg: "Crescendo attack detected at turn 4", severity: "medium" },
    { time: "14:32:05", type: "blue", agent: "Output Filter", msg: "Intercepted system prompt fragment", severity: "high" },
    { time: "14:32:01", type: "red", agent: "Data Leakage", msg: "PII extraction attempt", severity: "medium" },
    { time: "14:31:58", type: "judge", agent: "LLM Judge", msg: "Evaluated attack success: 0.72 confidence", severity: "info" },
  ];

  const statusColor = { running: "#fbbf24", done: "#34d399", pending: "#525252" };
  const severityStyle = {
    ...
    info: { bg: "rgba(255,255,255,0.04)", border: "rgba(255,255,255,0.08)", color: "#737373" },
  };
...
export default ScanMonitorContent;